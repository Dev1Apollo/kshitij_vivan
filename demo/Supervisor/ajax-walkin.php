...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `lead`  " . $where . " and isNewInquiry='0'  and   walkin_datetime != '' order by STR_TO_DATE(walkin_datetime,'%d-%m-%Y') asc";
    $countstr = "SELECT count(*) as TotalRow,avg(DATEDIFF(STR_TO_DATE(walkin_datetime,'%d-%m-%Y'),STR_TO_DATE(inquiryEnterDate,'%d-%m-%Y'))) AS timediff FROM `lead`  " . $where . " and  isNewInquiry='0' and   walkin_datetime != ''  ";
...
?>
        ...
        <link href="demo/assets/global/plugins/datatables/datatables.css" rel="stylesheet" type="text/css" />
        <link href="demo/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
        ...
        <table class="table table-bordered table-hover center table-responsive dt-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">Customer Mobile</th>
