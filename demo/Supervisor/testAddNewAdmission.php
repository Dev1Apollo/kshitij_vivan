            ...
            <div class="page-content">
                <div class="container">
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo $web_url; ?>Supervisor/StudentEntry.php">List of Student Admission</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <select name="Title" id="Title" class="form-control" required="">
                                                            ...
                                                            <option value="<?php if ($row['title'] == 'MR') {
                                                                                echo 'selected';
                                                                            } ?>">Mr.</option>
                                                            <option value="<?php if ($row['title'] == 'MRS') {
                                                                                echo 'selected';
                                                                            } ?>">Mrs.</option>
                                                            <option value="<?php if ($row['title'] == 'Miss') {
                                                                                echo 'selected';
                                                                            } ?>">Miss.</option>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response != 0) {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Supervisor/AddLead.php?token=' + response;
                    }
                }
