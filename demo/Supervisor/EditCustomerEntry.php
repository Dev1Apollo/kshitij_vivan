                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="CategoryOfCustomer" id="CategoryOfCustomer" class="form-control">
                                                    ...
                                                    <option value="Inquired" <?php if ($row['categoryOfCustomer'] == 'Inquired') {
                                                                                    echo 'selected';
                                                                                } ?>>Inquired</option>
                                                    <option value="Regular" <?php if ($row['categoryOfCustomer'] == 'Regular') {
                                                                                echo 'selected';
                                                                            } ?>>Regular</option>
                                                    <option value="Silver" <?php if ($row['categoryOfCustomer'] == 'Silver') {
                                                                                echo 'selected';
                                                                            } ?>>Silver</option>
                                                    <option value="Gold" <?php if ($row['categoryOfCustomer'] == 'Gold') {
                                                                                echo 'selected';
                                                                            } ?>>Gold</option>
                                                    <option value="Platinum" <?php if ($row['categoryOfCustomer'] == 'Platinum') {
                                                                                    echo 'selected';
                                                                                } ?>>Platinum</option>
                                                </select>
                                            </div>
