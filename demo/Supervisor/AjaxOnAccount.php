...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM studentadmission  " . $where . "";
    //    $filterstr = "SELECT * FROM `studentadmission`  " . $where . " and isDelete='0'  and  istatus='1' order by  stud_id desc";
    $countstr = "SELECT count(*) as TotalRow FROM studentadmission  " . $where . "";
            ...
            <table class="table table-bordered table-hover center table-responsive dt-responsive" width="100%" id="tableC">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-md-line-input ">
                                    <a href="<?php echo $web_url; ?>Supervisor/AddOnAccountFee.php?token=<?php echo $rowfilter['stud_id']; ?>">
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <a  class="btn blue" href="<?php echo $web_url; ?>Supervisor/AddOnAccountFee.php?token=<?php echo $rowfilter['stud_id']; ?>" title="REGISTRATION FEES"><i class="fa fa-bars"></i></a>
