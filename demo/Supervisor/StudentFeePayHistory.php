...
<body class="page-container-bg-solid page-boxed">
                        ...
                        <div class="col-md-10">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    ...
                                    <a class="btn blue pull-right" style="margin-right: 5px !important;" href="<?php echo $web_url; ?>Supervisor/StudentFeesHistory.php?token=<?php echo $_REQUEST['token']; ?>&studentcourseId=<?php echo $_REQUEST['studentcourseId']; ?>" title="Emi Chart"><i class="fa fa-history iconshowFirst"></i><strong> Emi Chart </strong></a>
                                </div>
    ...
    <script>
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Supervisor/AjaxStudentFeeHistory.php",
                data: {
                    action: 'ListUser',
                    Page: Page,
                    stud_id: stud_id,
