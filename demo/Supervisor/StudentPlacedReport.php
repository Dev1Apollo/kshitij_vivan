...
<head>
	<meta charset="utf-8" />
	<title><?php echo $ProjectName; ?> | Student Placed Report </title>
...
<body class="page-container-bg-solid page-boxed">
			...
			<div class="page-content">
				<div class="container">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span>Student Placed Report</span>
						</li>
					</ul>
								...
								<div class="portlet light ">
									<div class="portlet-title">
										<div class="caption grey-gallery">
											...
											<span class="caption-subject bold uppercase">List of Student Placed</span>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		function PageLoadData(Page) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $web_url; ?>Supervisor/AjaxStudentPlacedReport.php",
				data: {
					action: 'ListUser',
					Page: Page,
					FormDate: FormDate,
		...
		function exportexceldata() {
			...
			var Url = '<?php echo $web_url; ?>Supervisor/exportStudentPlacedReport.php?FormDate=' + FormDate + '&ToDate=' + ToDate;
			window.open(
				Url,
