...
<body class="page-container-bg-solid page-boxed">
    ...
    <script>
        ...
        function exportexceldata() {
            ...
            window.location.href = 'export-Student-Enrollment-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + '&studentPortal_Id=' + studentPortal_Id + '&studentStatus=' + studentStatus+'&branchid='+ branchid;
        }
    </script>
</body>
