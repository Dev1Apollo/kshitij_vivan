                        ...
                        <div class="col-md-10">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    ...
                                    <a href="<?php echo $web_url; ?>Supervisor/AddCustomerEntry.php" class="btn blue" style="float: right;" title="Add Employee">ADD Customer Entry</a>
                                </div>
    ...
    <script type="text/javascript">
        function deletedata(task, id) {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Supervisor/AjaxCustomerEntry.php",
                    data: {
                        action: task,
                        ID: id
                    },
