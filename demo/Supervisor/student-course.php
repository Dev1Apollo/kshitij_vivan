                                                ...
                                                <div class="row">
                                                    ...
                                                    <!--<div class="form-group col-md-4">
                                                        ...
                                                        /*    $querysBranch = "SELECT * FROM `branchmaster` where isDelete='0' order by  branchid asc";
                                                            ...
                                                            echo '<select class="form-control" name="branchid" id="branchid" required>';
                                                    ...
                                                    <?php // } else {?> 
                                                        <input type="hidden" value="<?php echo $query['branchId']; ?>" name="branchid" id="branchid">
                                                    <?php // } ?>
                                                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response != 0) {
                                    ...
                                    window.location.href = '<?php echo $web_url; ?>Supervisor/StudentCourseDetails.php?token=' + response;
                                }
                            }
                        });
                    } else {
