                        ...
                        <div class="col-md-10">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    ...
                                    <div id="admission">
                                        <!--<a href="<?php echo $web_url; ?>Supervisor/AddNewAdmission.php" class="btn blue" style="float: right;" title="Add New Admission">ADD New Enrollment</a>-->
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function isRegister(task, id) {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Supervisor/AjaxStudentEntry.php",
                    data: {
                        action: task,
                        ID: id
                    },
                    success: function(response) {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Supervisor/student-course.php?token=' + response;
                        return false;
                    }
                });
            }
