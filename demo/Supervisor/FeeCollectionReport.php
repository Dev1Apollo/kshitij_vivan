...
<body class="page-container-bg-solid page-boxed">
    ...
    <script>
        ...
        function exportexceldata() {
            ...
            var StudentName = $('#StudentName').val();
            var branchid = $("#branchid").val();
            window.location.href = 'export-Fee-Collection-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + '&studentPortal_Id=' + studentPortal_Id + '&StudentName=' + StudentName+"&branchid="+branchid;
        }
    </script>
</body>
