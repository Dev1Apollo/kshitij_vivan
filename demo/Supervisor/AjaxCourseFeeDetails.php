                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input">
                                <a class="btn blue" href="<?php echo $web_url; ?>Supervisor/StudentEnrollmentFees.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="STUDENT FEES"><i class="fa fa-rupee"></i><strong> Fees</strong></a>
                                <!--                                <a  class="btn blue" href="<?php // echo $web_url; 
                                                                                                ?>Supervisor/StudentFeesHistory.php?token=<?php // echo $rowfilter['stud_id']; 
                                                                                                                                            ?>&studentcourseId=<?php // echo $rowfilter['studentcourseId']; 
                                                                                                                                                                                            ?>"   title="STUDENT HISTROY"><i class="fa fa-history iconshowFirst"></i></a>
                                <a  class="btn blue"  href="<?php // echo $web_url; 
                                                            ?>Supervisor/EditStudentCourse.php?token=<?php // echo $rowfilter['stud_id']; 
                                                                                                        ?>&studentcourseId=<?php // echo $rowfilter['studentcourseId']; 
                                                                                                                                                        ?>" title="EDIT STUDENT"><i class="fa fa-edit"></i></a>-->
                                <!--<a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php // echo $rowfilter['stud_id']; 
                                                                                                            ?>','<?php // echo $rowfilter['studentcourseId']; 
                                                                                                                    ?>');"   title="Delete"><i class="fa fa-history iconshowFirst"></i></a>-->
                            </div>
                        </td>
                    </tr>
                <?php } ?>
