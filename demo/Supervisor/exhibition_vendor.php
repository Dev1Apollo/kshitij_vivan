...
<head>
    ...
    <link href="demo/assets/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
    <link href="demo/assets/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
...
<body class="m-bg">
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        ...
        <div style="display: none; z-index: 10060;" id="loading">
            <img id="loading-image" src="<?php echo $web_url ?>Supervisor/images/loader.gif">
        </div>
        <!-- end::Header -->
        <!-- begin::Body -->
        <div
    ...
    <script src="demo/assets/datatables/datatables.js" type="text/javascript"></script>
    <script src="demo/assets/datatables/table-datatables-responsive.js" type="text/javascript"></script>
    <script>
