...
<head>
    <meta charset="utf-8" />
    <title><?php echo $ProjectName; ?> |Booked Inquiry</title>
...
<body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption grey-gallery">
                                        ...
                                        <span class="caption-subject bold uppercase">List of Booked Inquiry</span>
                                    </div>
                                </div>
                                            ...
                                            <form role="form" method="POST" action="" name="frmSearch" id="frmSearch" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        // echo "<option value=''>Select  Any Inquiry Source</option>";
    ...
    <script>
        ...
        function exportexceldata() {
            ...
            var InquirySource = $('#InquirySource').val();
            var employeeMasterId = $("#employeeMasterId").val();
            window.location.href = 'export-inquiry-source.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&InquirySource=" + InquirySource + "&employeeMasterId=" + employeeMasterId;
        }
    </script>
</body>
