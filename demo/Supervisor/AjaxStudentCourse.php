                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input">
                                ...
                                <a class="btn blue" href="<?php echo $web_url; ?>Supervisor/EditStudentCourse.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="EDIT STUDENT"><i class="fa fa-edit"></i></a>
