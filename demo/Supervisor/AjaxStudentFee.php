                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input">
                                <a class="btn blue" href="<?php echo $web_url; ?>Supervisor/StudentFeePayHistory.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="Fee History"><i class="fa fa-database"></i><strong> Fees History</strong></a>
                                <!--<a  class="btn blue"  href="<?php echo $web_url; ?>Supervisor/StudentEnrollmentFees.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="STUDENT FEES"><i class="fa fa-rupee"></i></a>-->
                                <a class="btn blue" href="<?php echo $web_url; ?>Supervisor/StudentFeesHistory.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="Emi Chart"><i class="fa fa-history iconshowFirst"></i><strong> Emi Chart </strong></a>
