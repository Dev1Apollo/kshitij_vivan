...
if ($_POST['action'] == 'ListUser') {
    ...
    //    $whereEmpId = " and studentadmission.branchId =2";
    ...
    //and studentfee.isCancel=0
    $filterstr = "select studentfee.*, studentadmission.* from studentadmission,studentfee where studentfee.stud_id=studentadmission.stud_id and studentfee.feetype not in (5)  and studentfee.amount!=0 " . $where . $whereEmpId . " ORDER BY STR_TO_DATE(studentfee.payDate,'%d-%m-%Y') ASC ";
    $countstr = "select count(*) as TotalRow,sum(amount) TotalAmount from studentadmission,studentfee where studentfee.stud_id=studentadmission.stud_id and studentfee.amount!=0 and studentfee.feetype not in (5) " . $where . $whereEmpId . " ";
        ...
        <div class="row m-search-box">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <!--                    <h4 class="col-md-6"><span class="bold" style="color: #e31e24">Average Days:</span>&nbsp;&nbsp;<?php // echo round($resrowc['timediff'], 2) . ' Days';  
                                                                                                                                            ?></h4>
                   <h4 class="col-md-6"><span class="bold" style="color: #e31e24">Total Booked Amount:</span>&nbsp;&nbsp;<?php // echo $resrowc['bookedamount'];  
                                                                                                                            ?></h4> -->
                    <h4 class="col-md-6"><span class="bold" style="color: #e31e24">Total Collection Amount:</span>&nbsp;&nbsp;<?php echo $resrowc['TotalAmount']; ?></h4>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <!--                            <td>
                                <div class="form-group form-md-line-input "><?php
                                                                            //                                    if ($rowfilter['studentcourseId'] != NULL && $rowfilter['studentcourseId'] != 0) {
                                                                            //                                        $Course = mysqli_fetch_array(mysqli_query($dbconn,"SELECT * FROM `studentcourse` where studentcourseId='" . $rowfilter['studentcourseId'] . "' "));
                            ...
                            <td>
                                <div class="form-group form-md-line-input "><?php
                                                                            //                                echo "select * from bank where bankId=".$rowfilter['toBank']." ";
            ...
            <td>
                <div class="form-group form-md-line-input "><?php
                            ...
                            <!--                            <td>
                                <div class="form-group form-md-line-input "><?php
                                                                            //                                if($rowfilter['rejectiontype'])
                                                                            //                                    echo $rowfilter['rejectiontype'];
                                                                            ?> 
                                </div>
                            </td> -->
                            <td>
                                <div class="form-group form-md-line-input "><?php
                                                                            if ($rowfilter['isCancel'] == 1) {
                                                                                echo $rowfilter['CancellationComment'];
                                                                            } else {
