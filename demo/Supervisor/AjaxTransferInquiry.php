...
?>
        ...
        <form role="form" method="POST" action="" name="frmparameter" id="frmparameter" enctype="multipart/form-data">
            ...
            <script src="<?php echo $web_url; ?>Supervisor/assets/global/plugins/bootstrap-datetimepicker/components-date-time-pickers.js" type="text/javascript"></script>


            <script type="text/javascript">
                function checkclose() {
                    window.location.href = '<?php echo $web_url; ?>Supervisor/TransferInquiry.php';
                }
