                                        ...
                                        <div class="row m-search-box">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    echo '<select class="form-control" name="branchid" id="branchid" ' . ($_SESSION['EmployeeType'] == 'Supervisor' ? 'required' : '') . '>';
        ...
        function PageLoadData(Page) {
            ...
            <?php if ($_SESSION['EmployeeType'] == 'Supervisor') { ?>
                if (!branchid) {
                    ...
                    return false; // Stop execution if branch is not selected
                }
            <?php } ?>
            $('#loading').css("display", "block");
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Supervisor/AjaxBankDeposit.php",
                data: {
                    action: 'ListUser',
                    Page: Page,
                    FormDate: FormDate,
