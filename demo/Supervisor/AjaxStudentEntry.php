                        ...
                        <td>
                            <div class="form-group form-md-line-input">
                                ...
                                <?php if ($_POST['student'] == 'Registered_Student') { ?>
                                    <a class="btn blue" href="<?php echo $web_url; ?>Supervisor/EditRegisterStudent.php?token=<?php echo $rowfilter['leadId']; ?>&stud_id=<?php echo $rowfilter['stud_id']; ?>" title="EDIT REGISTERED STUDENT"><i class="fa fa-edit"></i></a>
