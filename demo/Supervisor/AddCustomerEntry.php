                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input name="LastName" id="LastName" class="form-control" placeholder="Enter The Last Name" type="text">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="form_control_1">Mobile No.*</label>
                                                        <div id="errordiv"></div>
                                                        <input name="Mobile" id="Mobile" class="form-control" placeholder="Enter The Mobile No." pattern="[0-9]{10}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        echo '<select class="form-control" name="InquirySource" id="InquirySource" required>';
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <?php
                                                        $querysInq = "SELECT * FROM `status`  where isDelete='0'  and  istatus='1' and NOT statusId in ('2','3','4','5','6','7') order by  statusId asc";
                                                        $resultsInq = mysqli_query($dbconn, $querysInq) or die(mysqli_error($dbconn));
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response != 0) {
                        ...
                        window.location.href="<?php echo $web_url; ?>Supervisor/NewInquiry.php";
                        //window.open('<?php echo $web_url; ?>Supervisor/AddLead.php?token=' + response, 'popUpWindow', 'height=500,width=1250,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes');
                    }
                }
