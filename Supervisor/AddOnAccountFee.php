...
<head>
    <meta charset="utf-8" />
    <title><?php echo $ProjectName; ?> | On Account Fees </title>
...
<body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption grey-gallery">
                                        ...
                                        <span class="caption-subject bold uppercase" id="listdetail">List Of On Account Fee</span>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="portlet light ">
                                                                <div class="portlet-title">
                                                                    <div class="caption grey-gallery">
                                                                        <i class="icon-settings grey-gallery"></i>
                                                                        <span class="caption-subject bold uppercase" id="listdetail"> On Account Fees</span>
                                                                    </div>
                                                                    <a class="btn blue pull-right " data-toggle="modal" href="#large"> Add On Account Fees </a>
                                                                        ...
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="modal-body">
                                                                                        <?php
                                                                                        $filterstudent = "select studentadmission.*,studentcourse.*  from studentadmission,studentcourse where studentadmission.stud_id = studentcourse.stud_id and studentcourse.istatus=1 and studentadmission.stud_id = '" . $_REQUEST['token'] . "'";
                                                                                        $datastudent = mysqli_fetch_array(mysqli_query($dbconn, $filterstudent));
                                                                                        $datastudent['studentcourseId'];
                                                                                        ...
                                                                                        <div class="portlet-body form">
                                                                                            <form role="form" method="POST" action="" name="frmparameter" id="frmparameter" enctype="multipart/form-data">
                                                                                                <input type="hidden" value="AddOnAccountfees" name="action" id="action">
                                                                                                <input type="hidden" value="<?php echo $_REQUEST['token']; ?>" name="stud_id" id="stud_id">
                                                                                                <input type="hidden" value="<?php echo $datastudent['studentcourseId']; ?>" name="studentcourseId" id="studentcourseId">
                                                                                                ...
                                                                                                <div class="form-body">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="form-group row col-md-offset-1">
                                                                                                            <label for="form_control_1" class="col-md-2">Fee Pay For*</label>
                                                                                                            <div class="col-md-6">
                                                                                                                <div class="txt_field">
                                                                                                                    <select name="payFor" id="payFor" class="form-control">
                                                                                                                        <option value="">Select Fee Pay For</option>
                                                                                                                        <!--<input name="payFor" id="payFor" class="form-control"  placeholder="Enter Fee Pay For" type="text" required="">-->
                                                                                                                        <?php
                                                                                                                        $fiterPayFor = mysqli_query($dbconn, "select * from feepayfor where istatus='1' and isDelete='0'");
                                                                                                                        while ($rowFee = mysqli_fetch_array($fiterPayFor)) {
                                                                                                                            echo "<option value=" . $rowFee['FeePayForId'] . " >" . $rowFee['FeePayForName'] . "</option>";
                                                                                                                        }
                                                                                                                        ?>
                                                                                                                    </select>
                                                                                                                </div>
                                                                                                        ...
                                                                                                        <div class="form-group row col-md-offset-1" style="display:none;" id="emitypeDiv">
                                                                                                            ...
                                                                                                            <div class="col-md-6">
                                                                                                                <div class="txt_field" id="emitypeInputDiv">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group row col-md-offset-1">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response != 0) {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Supervisor/AddOnAccountFee.php?token=' + response;
                    }
                }
            });
        });
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Supervisor/AjaxStudentOnAccountFee.php",
                data: {
                    action: 'ListUser',
                    Page: Page,
                    stud_id: stud_id
