...
<head>
	<meta charset="utf-8" />
	<title><?php echo $ProjectName; ?> | Company Master Report </title>
...
<body class="page-container-bg-solid page-boxed">
			...
			<div class="page-content">
				<div class="container">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span>Company Master Report</span>
						</li>
					</ul>
	...
	<script type="text/javascript">
		...
		function PageLoadData(Page) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $web_url; ?>Supervisor/AjaxCompanyMasterReport.php",
				data: {
					action: 'ListUser',
					Page: Page,
					FormDate: FormDate,
		...
		function exportexceldata() {
			...
			var Url = '<?php echo $web_url; ?>Supervisor/exportCompanyMasterReport.php?FormDate=' + FormDate + '&ToDate=' + ToDate;
			window.open(
				Url,
