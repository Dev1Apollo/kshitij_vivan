                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php if (isset($_SESSION['EmployeeId']) && isset($_SESSION['EmployeeName'])) { ?>
                        ...
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                                                                        ...
                                                                        ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/CustomerEntry.php">Manage Customer</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                                                                        ...
                                                                        ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/NewInquiry.php">New Inquiry</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                                                                        ...
                                                                        ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/MyFollowup.php">My Follow Up</a>
                        </li>
                        ...
                        <!--<li class="menu-dropdown classic-menu-dropdown  <?php
                                                                            ...
                                                                            ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/TransferInquiry.php">Transfer Inquiry</a>
                        </li>-->
                        ...
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                                                                        ...
                                                                        ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/StudentEntry.php">Student Admission</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                                                                        ...
                                                                        ?>">
                            <a href="<?php echo $web_url; ?>Supervisor/StudentCouncillor.php">Student Councillor</a>
                        </li>
                    <?php
                    }
                    ?>
