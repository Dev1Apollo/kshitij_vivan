...
<body class="page-container-bg-solid page-boxed">
    ...
    <div class="page-container">
                            ...
                            <div class="col-md-10">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        $lid = $row['leadId'];
                                        $branchmaster = mysqli_fetch_array(mysqli_query($dbconn, "SELECT b.branchid,b.branchname FROM `employeemaster` as e inner join branchmaster as b on e.branchid=b.branchid where e.isDelete=0 and b.isDelete=0 and e.employeeMasterId = '" . $row['employeeMasterId'] . "'"));
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Phone</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Mobile No. 1*</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Mobile No. 2</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Address 1*</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Address 2</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">City*</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Pincode</label>
                                                            <div id="errordiv"></div>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="form_control_1" class="col-sm-3 col-form-label">Branch</label>
                                                            <div class="col-sm-9">
                                                                <?php
                                                                ...
                                                                while ($rowsBranch = mysqli_fetch_array($resultsBranch)) {
                                                                    if($branchmaster['branchid'] == $rowsBranch['branchid']){
                                                                        echo "<option value='" . $rowsBranch['branchid'] . "' selected>" . $rowsBranch['branchname'] . "</option>";
                                                                    } else {
        ...
        <script type="text/javascript">
            function getcity() {
                var q = $('#state').val();
                var urlp = '<?php echo $web_url; ?>Supervisor/findCity.php?sId=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
            ...
            function checkclose() {
                window.location.href = '<?php echo $web_url; ?>Supervisor/StudentRegistration.php';
            }
            ...
            function chkMobileno(ID) {
                var q = $('#Mobile').val();
                var urlp = '<?php echo $web_url; ?>Supervisor/findAdminCEMobile.php?ID=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
                    success: function(data) {
