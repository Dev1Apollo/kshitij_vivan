...
// 	$countstr = "SELECT count(*) as TotalRow FROM studentadmission  " . $where . " and isRegister = '1' and isAdmission = '1' and branchId=" . $_SESSION['branchid'] . "";
    $filterstr = "SELECT * FROM studentadmission  " . $where . " and isRegister = '1' and isAdmission = '1'";
	//    $filterstr = "SELECT * FROM `studentadmission`  " . $where . " and isDelete='0'  and  istatus='1' order by  stud_id desc";
	$countstr = "SELECT count(*) as TotalRow FROM studentadmission  " . $where . " and isRegister = '1' and isAdmission = '1'";
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<div class="form-group form-md-line-input "><a href="StudentPlacementHistory.php?token=<?php echo $rowfilter['stud_id']; ?>"><?php echo $rowfilter['title'] . ' ' . $rowfilter['firstName'] . ' ' . $rowfilter['middleName'] . ' ' . $rowfilter['surName']; ?> </a>
							</div>
						</td>
						<td>
						...
						<!--                        <td>
                            <div class="form-group form-md-line-input">
                                  <a  class="btn blue" href="<?php // echo $web_url; 
																?>Supervisor/StudentLedgerFees.php?token=<?php // echo $rowfilter['stud_id']; 
																											?>" title="STUDENT ENROLLMENT FEES"><i class="fa fa-bars"></i></a>
                                
                                
                                            <a  class="btn blue" href="<?php // echo $web_url; 
																		?>Supervisor/EditCustomerEntry.php?token=<?php // echo $rowfilter['customerEntryId']; 
																													?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php // echo $rowfilter['customerEntryId']; 
                                    ...
                                    <a  class="btn blue" href="<?php // echo $web_url; 
																?>Supervisor/EditRegisterStudent.php?token=<?php // echo $rowfilter['leadId']; 
																											?>" title="EDIT REGISTERED STUDENT"><i class="fa fa-edit"></i></a>
                            </div>
                        </td>-->
