...
SELECT Count(*) as count,'6' as statusId FROM lead where STR_TO_DATE(lead.walkin_datetime,'%d-%m-%Y') <= STR_TO_DATE('$_REQUEST[FormDate]','%d-%m-%Y') 
...
<body class="page-container-bg-solid page-boxed">
                                        ...
                                        <div class="portlet light ">
                                            ...
                                            <div class="portlet-body">
                                                <ul class="list-group">
                                                    ...
                                                    ?>
                                                    <li class="list-group-item bg-red bg-font-red"> <img src="demo/assets/call.png" /> <strong>To Call Back :</strong> <span class="pull-right"> <strong><?php // echo $rowtodaycallback['count']; 
                                                                                                                                                                                                            ?></strong> </span></li>
                                                    <li class="list-group-item bg-red bg-font-red"> <img src="demo/assets/walk.png" /> <strong>To Walk-in :</strong> <span class="pull-right"> <strong> <?php // echo $rowwalkin['count']; 
                                                                                                                                                                                                        ?></strong></span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="portlet light ">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
                                                ...
                                                <?php
                                                $filterTarget = mysqli_fetch_array(mysqli_query($dbconn, "Select * from target where month = MONTH(CURRENT_DATE()) and year = YEAR(CURRENT_DATE()) and isDelete = 0 and iStatus=1"));
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php
                                                            ...
                                                            echo $filterFPS['count']; // $filterTarget['achieveFPS'] 
                                                            ?></td>
                                                    <td> <?php
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body bg-grey-salt">
                    ...
                    <h4 class="font-dark"><img src="demo/assets/call-back.png" /> <strong>To Call Back :</strong> <span class="pull-right"> <strong id="callbackcount"></strong> </span></h4>
                    <h4 class="font-dark"><img src="demo/assets/walking.png" /> <strong> To Walk-in :</strong> <span class="pull-right"> <strong id="walkingcount"></strong> </span></h4>
    ...
    <script src="demo/assets/canvasjs.min.js"></script>
