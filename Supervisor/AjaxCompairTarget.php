...
if ($_POST['action'] == 'ListUser') {
    ...
    if ($_REQUEST['branch'] != NULL && isset($_REQUEST['branch'])) {
        ...
        $whereE .= " and employeeMasterId in (SELECT employeeMasterId FROM `employeemaster` where istatus=1 and isDelete=0 and branchid='" . $_REQUEST['branch'] . "')";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <?php
                            ...
                            $inquiry = mysqli_fetch_array(mysqli_query($dbconn, "SELECT count(*) as TotalRow FROM lead where  MONTH(STR_TO_DATE(walkin_datetime,'%d-%m-%Y'))='" . $_REQUEST['targetMonth'] . "' and YEAR(STR_TO_DATE(walkin_datetime,'%d-%m-%Y'))='" . $_REQUEST['targetYear'] . "' and isNewInquiry='0' " . $whereE . "  "));
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        $filterEnroll = mysqli_fetch_array(mysqli_query($dbconn, "SELECT count(*) as TotalRow FROM lead where  MONTH(STR_TO_DATE(nextFollowupModifyDate,'%d-%m-%Y'))='" . $_REQUEST['targetMonth'] . "' and YEAR(STR_TO_DATE(nextFollowupModifyDate,'%d-%m-%Y'))='" . $_REQUEST['targetYear'] . "' and isNewInquiry='0' and statusId='3' " . $whereE . " "));
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        $filterBooking = mysqli_fetch_array(mysqli_query($dbconn, "SELECT sum(booking_amount) as TotalRow FROM lead where  MONTH(STR_TO_DATE(nextFollowupModifyDate,'%d-%m-%Y'))='" . $_REQUEST['targetMonth'] . "' and YEAR(STR_TO_DATE(nextFollowupModifyDate,'%d-%m-%Y'))='" . $_REQUEST['targetYear'] . "' and isNewInquiry='0' and statusId='3' " . $whereE . " "));
                ...
                <tr>
                    ...
                    <td> <?php
                            ...
                            $filterCollection = mysqli_fetch_array(mysqli_query($dbconn, "select sum(amount) as collection from studentfee INNER JOIN studentadmission ON studentadmission.stud_id = studentfee.stud_id where MONTH(STR_TO_DATE(studentfee.payDate,'%d-%m-%Y'))='" . $_REQUEST['targetMonth'] . "' and YEAR(STR_TO_DATE(studentfee.payDate,'%d-%m-%Y'))='" . $_REQUEST['targetYear'] . "' " . $whereE . " "));
                ...
                <tr>
                    ...
                    <td> <?php
                            ...
                            ?></td>
                    <td> <?php echo 0; // $rowTarget['achieveFPS']   
                            ?></td>
                    <td> <?php
