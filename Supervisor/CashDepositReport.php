...
<body class="page-container-bg-solid page-boxed">
    ...
    <script>
        ...
        function exportexceldata() {
            ...
            var bankDeposit = $('#bankDeposit').val();
            var branchid = $("#branchid").val();
            window.location.href = 'export-cash-deposit-report.php?FromDate=' + FromDate + "&ToDate=" + ToDate + "&studentPortal_Id=" + studentPortal_Id + "&bankDeposit=" + bankDeposit+"&branchid="+branchid;
        }
    </script>
</body>
