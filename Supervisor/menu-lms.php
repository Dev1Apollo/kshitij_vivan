            ...
            <li>
                ...
                <ul class="m-submenu">
                    ...
                    <li>
                        <a class="
                        <?php
                        if (basename($_SERVER['REQUEST_URI']) == 'InquirySourceReportnew.php') {
                            echo 'curr';
                        }
                        ?>"
                           href="InquirySourceReportnew.php">Inquiry Source New</a>
                    </li>
                    ...
                    <li>
                        <a class="<?php
                        if (basename($_SERVER['REQUEST_URI']) == 'NewEmployeePerfomance.php') {
                            echo 'curr';
                        }
                        ?>" href="NewEmployeePerfomance.php">Employee Performance</a>
                    </li>
                </ul>
            </li>
