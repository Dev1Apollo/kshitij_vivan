...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `lead` " . $where . " and isNewInquiry='1'  order by  leadId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `lead` " . $where . " and isNewInquiry='1'";
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-md-line-input "><?php
                                                                            ...
                                                                            $employeemasters = mysqli_query($dbconn, "SELECT * FROM `support_employee`  where isDelete='0'  and  istatus='1' and id='" . $rowfilter['support_employee'] . "'");
                            ...
                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <?php } else { ?>
                                        <!--                                <button onclick="window.open('<?php echo $web_url; ?>Supervisor/AddInquiryFollowup.php?token=<?php echo $rowfilter['leadId']; ?>&cid=<?php echo $rowfilter['customerEntryId']; ?>')" vlaue="INQUIRY FOLLOWUP">INQUIRY FOLLOWUP</button>-->
