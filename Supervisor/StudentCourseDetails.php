                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row" style="margin-bottom: 20px">
                                        <!--                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <h4>Enrollment Id : <?php // echo $query['studentEnrollment']; 
                                                                    ?></h4>
                                            </div>
                                            <div class="col-md-4">
                                                <h4>Course Name : <?php
                                    ...
                                    <!--                                        <div class="row" style="margin-bottom: 20px">
                                            <div class="col-md-4">
                                                <h4>Student Name : <?php // echo $query['title'] . ' ' . $query['firstName'] . ' ' . $query['middleName'] . ' ' . $query['surName']; 
                                                                    ?></h4>
                                            </div>
                                            <div class="col-md-4">
                                                <h4>Mobile No : <?php // echo $query['mobileOne']; 
                                                                ?></h4>
                                            </div>
                                            <div class="col-md-4">
                                                <h4>Email ID : <?php // echo $query['email']; 
                                                                ?> </h4>
                                            </div>
                                        </div>-->
                                    ...
                                    <!--                                        <div class="row" style="margin-bottom: 20px">
                                            ...
                                            <div class="col-md-4">
                                                <h4>Offered Fees : <?php // echo $query['offeredfee']; 
                                                                    ?></h4>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <!--                                        <div class="row" style="margin-bottom: 20px">
                                            <div class="col-md-4">
                                                <h4>Date Of Join : <?php // echo $query['dateOfJoining']; 
                                                                    ?></h4>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <!--                                            <div class="row" style="margin-bottom: 20px">
                                                <div class="col-md-4">
                                                    <h4>Emi Start Date : <?php // echo $query['emiStartDate']; 
                                                                            ?></h4>
                                                </div>
                                                <div class="col-md-4">
                                                    <h4>No Of EMI : <?php // echo $query['noOfEmi']; 
                                                                    ?></h4>
                                                </div>
                                                <div class="col-md-4">
                                                    <h4>Emi Amount : <?php // echo $query['emiAmount']; 
                                                                        ?> </h4>
                                                </div>
                                            </div>-->
                                    <?php // } 
