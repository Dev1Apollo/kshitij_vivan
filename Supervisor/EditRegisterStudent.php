...
$result = mysqli_query($dbconn, "SELECT * FROM `studentadmission` WHERE `leadId`='" . $_REQUEST['token'] . "'");
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption grey-gallery">
                                        ...
                                        <span class="caption-subject bold uppercase"> Edit Student Registration</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form role="form" method="POST" action="" name="frmparameter" id="frmparameter" enctype="multipart/form-data">
                                        <input type="hidden" value="EditRegisteredStudent" name="action" id="action">
