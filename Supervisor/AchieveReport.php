...
<body class="page-container-bg-solid page-boxed">
                                    ...
                                    <form role="form" method="POST" action="" name="frmSearch" id="frmSearch" enctype="multipart/form-data">
                                        <div class="row m-search-box">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <?php
                                                    $querysBranch = "SELECT * FROM `branchmaster` where isDelete='0' order by  branchname asc";
    ...
    <script type="text/javascript">
        ...
        function exportexceldata() {
            ...
            var Url = '<?php echo $web_url; ?>Supervisor/exportAchieveReport.php?FormDate=' + FormDate + '&ToDate=' + ToDate+'&branchid='+branchid;
            window.open(
                Url,
