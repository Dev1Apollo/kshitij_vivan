...
<head>
    ...
    <link
        href="<?php echo $web_url; ?>Supervisor/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css"
...
<body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="col-md-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        <!-- <a data-toggle="modal" data-target="#exampleModal" class="btn blue"
                                            style="float: right;" title="Add Employee">Add Job</a> -->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="iCompanyId" id="iCompanyId" class="form-control"
                                                    ...
                                                    ?>
                                                        <option value="<?= $row['id'] ?>"><?= $row['strCompanyName'] ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="strExperience" id="strExperience" class="form-control"
                                                    placeholder="Enter Experience" required="" type="text">
                                            </div>
                                            <!-- </div> -->
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter End Date" name="strEndDate" class="form-control"
                                                    id="strEndDate" required />
                                            </div>
                                            <!-- </div> -->
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="strJobDescription" id="strJobDescription"
                                                    class="form-control" placeholder="Enter Job Description" required=""
                                                    type="text">
															</textarea>
                                            </div>
                                            <!-- </div> -->
    ...
    <script
        src="<?php echo $web_url; ?>Supervisor/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"
    ...
    <script type="text/javascript">
        ...
        function deletedata(task, id) {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Supervisor/AjaxJobMaster.php",
                    data: {
                        action: task,
                        ID: id
                    },
