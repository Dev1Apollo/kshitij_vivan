...
<head>
	<meta charset="utf-8" />
	<title><?php echo $ProjectName; ?> | Job Report </title>
...
<body class="page-container-bg-solid page-boxed">
								...
								<div class="portlet light ">
									<div class="portlet-title">
										<div class="caption grey-gallery">
											...
											<span class="caption-subject bold uppercase">List of Job Report</span>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		function PageLoadData(Page) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $web_url; ?>Supervisor/AjaxJobReport.php",
				data: {
					action: 'ListUser',
					Page: Page,
					FormDate: FormDate,
		...
		function exportexceldata() {
			...
			var Url = '<?php echo $web_url; ?>Supervisor/exportJobReport.php?FormDate=' + FormDate + '&ToDate=' + ToDate;
			window.open(
				Url,
