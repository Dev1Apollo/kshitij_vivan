...
<head>
    <meta charset="utf-8" />
    <title><?php echo $ProjectName; ?> |Send Sms</title>
    <?php include_once './include.php'; ?>
    <link href="/demo/Supervisor/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" type="text/css" />
</head>
...
<body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption grey-gallery">
                                        ...
                                        <span class="caption-subject bold uppercase">List of Send Sms</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row m-search-box">
                                        <div class="col-md-12">
                                            <form role="form" method="POST" action="" name="frmSearch" id="frmSearch" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="form-group  col-md-4">
                                                        <input type="text" value="" name="firstName" class="form-control" id="firstName" placeholder="Search By Name " />
                                                    </div>
                                                    <div class="form-group col-md-4">
    ...
    <script src="/demo/Supervisor/assets/jquery.character-counter.js" type="text/javascript"></script>
    ...
    <link href="/demo/Supervisor/assets/bootstrap-multiselect.css" rel="stylesheet" type="text/css" />
    <script src="/demo/Supervisor/assets/bootstrap-multiselect.js" type="text/javascript"></script>

    <script src="/demo/Supervisor/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        function PageLoadData(Page) {
            ...
            if (FormDate == '' && ToDate == '' && leadId == '' && InquiryStatus == '' && CategoryOfInquiry == '' && InquirySource == '' && firstName == '' && lastName == '' && mobileNo == '' && employeeMasterId == '') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    leadId: leadId,
                    CategoryOfInquiry: CategoryOfInquiry,
                    FormDate: FormDate,
                    ToDate: ToDate,
                    ...
                    lastName: lastName,
                    mobileNo: mobileNo,
                    EntryFormDate: EntryFormDate,
                    EntryToDate: EntryToDate,
