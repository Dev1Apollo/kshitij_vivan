...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT studentcourse.`stud_id`,studentcourse.`studentcourseId`,studentfee.chequeNo,studentfee.paymentMode,studentfee.bankName,studentcourse.courseId,studentfee.depositDate,studentfee.`payDate` , studentfee.`iGstRef` ,studentcourse.branchId,receiptNo,
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['receiptNo']; //$rowfilter['iGstRef']; ?>
                            </div>
                        </td>
                        <td>
