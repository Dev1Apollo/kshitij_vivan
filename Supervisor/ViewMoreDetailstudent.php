...
$connect = new connect();
include('IsLogin.php');
if ($_REQUEST['Token'] == 'TMC')
    $viewdetailname = "Total Monthly Collection";
else if ($_REQUEST['Token'] == 'TMP')
    $viewdetailname = "Total Monthly Projection";
...
<body class="page-container-bg-solid page-boxed">
    ...
    <script>
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Supervisor/AjaxViewDetailstudent.php",
                data: {
                    action: 'ListUser',
                    Page: Page,
