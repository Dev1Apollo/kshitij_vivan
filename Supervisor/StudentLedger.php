                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    ...
                                    <!--                                        <a href="<?php // echo $web_url; 
                                                                                            ?>Supervisor/SearchLeadStudent.php" class="btn blue" style="float: right;" title="Add New Admission">ADD New Admission</a>-->
                                </div>
    ...
    <script type="text/javascript">
        function deletedata(task, id) {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Supervisor/AjaxStudentLedger.php",
                    data: {
                        action: task,
                        ID: id
                    },
