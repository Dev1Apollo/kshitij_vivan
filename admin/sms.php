        ...
        <script type="text/javascript">
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "ajax-sms.php",
                                                                        data: {action: 'ListUser', Page: Page, InquiryStatus: InquiryStatus, leadId: leadId, CategoryOfInquiry: CategoryOfInquiry, FormDate: FormDate, ToDate: ToDate, InquirySource: InquirySource, firstName: firstName, lastName: lastName, mobileNo: mobileNo, EntryFormDate: EntryFormDate, EntryToDate: EntryToDate, branch : branch},
