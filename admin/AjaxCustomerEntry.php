        ...
        <table class="table table-bordered table-hover center table-responsive dt-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">No Of Inquiry</th>
                    <th class="desktop">No Of Booked Inquiry</th>
                    ...
                    <tr>
                        ...
                        <td style="width: 11%">
                            <div class="form-group form-md-line-input">
                                <a  class="btn blue" href="<?php echo $web_url; ?>admin/EditCustomerEntry.php?token=<?php echo $rowfilter['customerEntryId']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
            ...
            <!--                             <a  class="btn blue" href="<?php echo $web_url; ?>admin/AddLead.php?token=<?php echo $rowfilter['customerEntryId']; ?>" title="CREATE INQUIRY"><i class="fa fa-bars"></i></a>-->
                            </div>
                        </td>
