                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Customer Entry</span>
                                        </div>
<!--                                        <a href="<?php echo $web_url; ?>admin/AddCustomerEntry.php" class="btn blue" style="float: right;" title="Add Employee">ADD Customer Entry</a>-->
                                    </div>
                                        ...
                                        <div class="row m-search-box">
                                            <div class="col-md-12">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group  col-md-2">
                                                        <a href="#" class="btn blue btn-block " onclick="PageLoadData(1);"><i class="fa fa-search"></i>&nbsp;Search</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxCustomerEntry.php",
