...
$getstudentId = mysqli_query($dbconn, "select *  from studentcourse where istatus=1 and  stud_id='" . $stud_id . "' and studentcourseId='" . $studentcourseId . "' and studentcourse.istatus=1");
...
//    echo "Select studentcourse.offeredfee,studentcourse.emiAmount ,studentemidetail.booking_amount,studentemidetail.joinAmount ,sum((select emiAmount from  studentemidetail stud where studentemidetail.studemiId=stud.studemiId))as totalemiAmount , sum((select actualReceivedAmount from studentemidetail stud where studentemidetail.studemiId=stud.studemiId)) as actualReceivedAmount  from studentcourse join studentemidetail on studentemidetail.studentcourseId = studentcourse.studentcourseId where studentemidetail.stud_id = '" . $stud_id . "' and studentemidetail.studentcourseId = '" . $studcourseId . "' group by studentemidetail.studentcourseId";
    $query = mysqli_fetch_array(mysqli_query($dbconn, "Select studentcourse.offeredfee,studentcourse.emiAmount ,studentemidetail.booking_amount,studentemidetail.joinAmount ,sum((select emiAmount from  studentemidetail stud where studentemidetail.studemiId=stud.studemiId and studentemidetail.isDelete=0))as totalemiAmount , sum((select actualReceivedAmount from studentemidetail stud where studentemidetail.studemiId=stud.studemiId and studentemidetail.isDelete=0)) as actualReceivedAmount  from studentcourse join studentemidetail on studentemidetail.studentcourseId = studentcourse.studentcourseId where studentemidetail.stud_id = '" . $stud_id . "' and studentemidetail.studentcourseId = '" . $studcourseId . "' and studentcourse.istatus=1 and studentemidetail.isDelete=0 group by studentemidetail.studentcourseId"));
...
$dataemi .= "##@@##";
$querysInq = "SELECT * FROM studentemidetail where stud_id='" . $stud_id . "' and studentemidetail.isDelete=0 and isPaid=0 and studentcourseId='" . $studcourseId . "' order by studemiId asc";
