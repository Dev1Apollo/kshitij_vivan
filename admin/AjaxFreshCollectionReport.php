...
if ($_POST['action'] == 'ListUser') {
   $where = "";
    ...
    $countstr = "select count(DISTINCT studentfee.stud_id) as TotalRow, studentfee.*,studentadmission.* FROM `studentfee`,studentadmission WHERE studentadmission.stud_id=studentfee.stud_id and studentfee.amount!=0 and studentfee.feetype not in (5) and studentfee.isCancel=0 " . $where . " ";
