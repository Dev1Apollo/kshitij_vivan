...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Employee Master </title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Employee Master</span>
                                        </div>
                                        <a href="<?php echo $web_url; ?>admin/AddEmployeeMaster.php" class="btn blue" style="float: right;" title="Add Employee">ADD Employee Master</a>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxEmployeeMaster.php",
