...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `employeemaster`  " . $where . " and isDelete='0'  and  istatus='1' order by  employeeMasterId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `employeemaster`  " . $where . " and isDelete='0' and  istatus='1' ";
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['gender']; ?> 
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input">
                                <a  class="btn blue" href="<?php echo $web_url; ?>admin/EmployeeChangePassword.php?token=<?php echo $rowfilter['employeeMasterId']; ?>" title="Change Password"><i class="fa-key fa"></i></a>
                                <a  class="btn blue" href="<?php echo $web_url; ?>admin/EditEmployeeMaster.php?token=<?php echo $rowfilter['employeeMasterId']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['employeeMasterId']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
...
if ($_REQUEST['action'] == 'Delete') {
    ...
    $where = ' where  	employeeMasterId=' . $_REQUEST['ID'];
