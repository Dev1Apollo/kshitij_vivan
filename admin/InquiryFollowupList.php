...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> |Inquiry Follow Up</title>
...
<!--        <script src="<?php echo $web_url; ?>admin/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>-->
            ...
            <script src="<?php echo $web_url; ?>admin/assets/pages/scripts/components-date-time-pickers.min.js" type="text/javascript"></script>
            <script>
