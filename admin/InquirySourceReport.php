    ...
    <body class="page-container-bg-solid page-boxed">
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    if (FormDate == '' && ToDate == '' && InquirySource == '' && Employee == '' && InquirySource == '')
                                                                    {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxInquirySourceReport.php",
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var Employee = $('#Employee').val();
                                                                    var branch = $('#branch').val();
                                                                    window.location.href = 'export-inquiry-source.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&InquirySource=" + InquirySource + "&Employee=" + Employee + "&branch=" + branch;
                                                                }
