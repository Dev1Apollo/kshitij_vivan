    ...
    <body class="page-container-bg-solid page-boxed">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" >List of Employee Perfomance</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row m-search-box">
                                            <div class="col-md-12">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="form-group col-lg-offset-1 col-md-2">
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxEmployeePerfomance.php",
                                                                        data: {action: 'ListUser', Page: Page, FormDate: FormDate, ToDate: ToDate, Employee: Employee, branch: branch},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var Employee = $('#Employee').val();
                                                                    var branch = $('#branch').val();
                                                                    window.location.href = 'export-employee-perfomance.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&Employee=" + Employee + "&branch=" + branch;
                                                                }
