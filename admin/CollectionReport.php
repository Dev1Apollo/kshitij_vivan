                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Student Collection Report</span>
                            </li>
                        </ul>
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        data: {action: 'ListUser', Page: Page, studentPortal_Id: studentPortal_Id, FormDate: FormDate, ToDate: ToDate, branch: branch},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var branch = $('#branch').val();
                                                                    var studentPortal_Id = $('#studentPortal_Id').val();
                                                                    window.location.href = 'export-Collection-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&branch=" + branch + "&studentPortal_Id=" + studentPortal_Id;
                                                                }
