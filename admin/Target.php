                            ...
                            <div class="col-md-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        <a href="<?php echo $web_url; ?>admin/AddTarget.php" class="btn blue" style="float: right;" title="Add Target">ADD Target</a>
                                    </div>
                                            ...
                                            <div class="row m-search-box">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group  col-md-2">
                                                        <a class="btn btn-block blue pull-right" onclick="PageLoadData(1);"><i class="fa fa-search"></i>&nbsp;&nbsp;Search</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
        ...
        <script type="text/javascript">
                                                            ...
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxTarget.php",
                                                            ...
                                                            function PageLoadData(Page) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo $web_url; ?>admin/AjaxTarget.php",
                                                                    data: {action: 'ListUser', Page: Page, targetMonth: targetMonth, targetYear: targetYear, branch: branch},
                                                                    success: function (msg) {
                                                                        $('#nodataFound').hide();
