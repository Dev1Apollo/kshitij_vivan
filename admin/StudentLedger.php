...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> |  Student Ledger</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" id="listdetail">List of Student Ledger</span>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-12"  >
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <select name="branchid" class="form-control" id="branchid">
                                                            ...
                                                            <?php $filterbranch = mysqli_query($dbconn, "select * from branchmaster where isDelete=0");
                                                                while ($rowBranch = mysqli_fetch_array($filterbranch)){ ?>
                                                                <option value="<?php echo $rowBranch['branchid']?>"><?php echo $rowBranch['branchname'];?></option>
                                                                <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group  col-md-2">
        ...
        <script type="text/javascript">
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxStudentLedger.php",
                                                            ...
                                                            function PageLoadData(Page) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo $web_url; ?>admin/AjaxStudentLedger.php",
                                                                    data: {action: 'ListUser', Page: Page,branchid: branchid, firstName: firstName, surName: surName, leaduniqueid: leaduniqueid},
                                                                    success: function (msg) {
