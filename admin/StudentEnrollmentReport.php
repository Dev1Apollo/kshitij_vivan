        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        data: {action: 'ListUser', Page: Page, studentStatus: studentStatus, studentPortal_Id: studentPortal_Id, FormDate: FormDate, ToDate: ToDate, branch: branch},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    window.location.href = 'export-Student-Enrollment-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&branch=" + branch + "&studentStatus=" + studentStatus + "&studentPortal_Id=" + studentPortal_Id;
                                                                }
