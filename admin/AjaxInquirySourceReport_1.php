...
//GROUP by customerentry.inquirySourceId
    ...
    $filterstr = "select count(*) as Inqcount,customerentry.inquirySourceId ,sum((select count(*) from lead l1 where l1.leadId = lead.leadId and lead.statusId='3' ".$where." )) as bookedInq ,"
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <div class="form-group form-md-line-input "><?php    $perntage = $rowfilter['bookedInq'] / $rowfilter['walkingcount'];
                                                echo number_format($perntage * 100, 2) . '%'; ?> 
                            </div>
                        </td>
                         <td>
                            <div class="form-group form-md-line-input "><?php if($rowfilter['bookingamount'] != '' && $rowfilter['bookedInq'] != 0) {echo $rowfilter['bookingamount']; }  else { echo '0';} ?> 
                            </div>
                        </td>
                        <?php
                    }
