...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> |Student GST Report </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" >List of Student GST Report</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <?php
                                                            $querysInqCat = "SELECT * FROM `branchmaster`  where isDelete='0' order by  branchid asc";
                                                            $resultsInqCat = mysqli_query($dbconn, $querysInqCat) or die(mysql_error());
                                                            echo '<select class="form-control" name="branchName" id="branchName" required="">';
                                                            echo "<option value='' >Select Branch</option>";
                                                            while ($rowsInqCat = mysqli_fetch_array($resultsInqCat)) {
                                                                echo "<option value='" . $rowsInqCat['branchid'] . "' >" . $rowsInqCat['branchname'] . "</option>";
                                                            }
                                                            echo "</select>";
                                                            ?>
                                                        </div>
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "AjaxStudentGSTReport.php",
                                                                        data: {action: 'ListUser', Page: Page, FormDate: FormDate, ToDate: ToDate, branchName: branchName},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var ToDate = $('#ToDate').val();
                                                                    var branchName = $('#branchName').val();
                                                                    window.location.href = 'export-student-gst-report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&branchName=" + branchName;
                                                                }
