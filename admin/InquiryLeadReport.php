        ...
        <script>
                                                                ...
                                                                function deletedata(task, id)
                                                                {
                                                                    ...
                                                                    if (confirm(errMsg)) {
                                                                        ...
                                                                        $.ajax({
                                                                            type: "POST",
                                                                            url: "<?php echo $web_url; ?>admin/AjaxInquiryLeadReport.php",
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    if (FormDate == '' && branch == '' && ToDate == '' && InquirySource == '' && CategoryOfInquiry == '' && Employee == '')
                                                                    {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxInquiryLeadReport.php",
                                                                        data: {action: 'ListUser', Page: Page, branch: branch, InquirySource: InquirySource, CategoryOfInquiry: CategoryOfInquiry, FormDate: FormDate, ToDate: ToDate, Employee: Employee},
                                                                        success: function (msg) {
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var InquirySource = $('#InquirySource').val();
                                                                    var branch = $('#branch').val();
                                                                    window.location.href = 'export-inquiry-lead-report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&Employee=" + Employee + "&InquirySource=" + InquirySource + "&branch=" + branch;
                                                                }
        </script>
    </body>
</html>