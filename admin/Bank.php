...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Deposit To Bank Master </title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Deposit To Bank Master</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editcity">Add Deposit To Bank Master</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddBank" name="action" id="action">
                                                <div class="form-body">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label for="form_control_1">Is GST?</label>
                                                        <select class="form-control" name="isGst" id="isGst">
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                <i class="icon-settings grey-gallery"></i>
                                                <span class="caption-subject bold uppercase">List of Deposit To Bank Name</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
        ...
        <script type="text/javascript">
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>admin/querydata.php',
                    data: {action: "GetAdminBank", ID: id},
                    success: function (response) {
                        document.getElementById("editcity").innerHTML = "EDIT DEPOSIT TO BANK ";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#bankName').val(json.bankName);
                        $('#isGst').val(json.isGst);
                        $('#action').val('EditBank');
                        $('<input>').attr('type', 'hidden').attr('name', 'bankId').attr('value', json.bankId).attr('id', 'bankId').appendTo('#frmparameter');
                    }
                });
            }
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxBank.php",
