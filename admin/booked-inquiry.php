    ...
    <body class="page-container-bg-solid page-boxed">
        ...
        <script>
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var Employee = $('#Employee').val();
                                                                    var branch = $('#branch').val();
                                                                    window.location.href = 'export-booked-inquiry.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&InquirySource=" + InquirySource + "&Employee=" + Employee+ "&branch=" + branch;
                                                                }
