...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | City </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editcity">Add City</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddCity" name="action" id="action">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="City" id="City"  class="form-control" placeholder="Enter Your City Name" required="" type="text">
                                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                <i class="icon-settings grey-gallery"></i>
                                                <span class="caption-subject bold uppercase">List of City</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                                ...
                                                <div class="col-md-12">
                                                    <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                        <div class="form-group col-md-offset-3 col-md-5">
                                                            <input type="text" value="" name="Search_Txt" class="form-control" id="Search_Txt" placeholder="Search City Name " required/>
                                                        </div>
        ...
        <script type="text/javascript">
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>admin/querydata.php',
                    data: {action: "GetAdminCity", ID: id},
                    success: function (response) {
                        document.getElementById("editcity").innerHTML = "EDIT City";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#State').val(json.sId);
                        $('#City').val(json.name);
                        $('#action').val('EditCity');
                        $('<input>').attr('type', 'hidden').attr('name', 'cityid').attr('value', json.cityid).attr('id', 'cityid').appendTo('#frmparameter');
                    }
                });
            }
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxCity.php",
