...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Expense </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editExpense">Add Expense</span>
                                            </div>
                                        </div>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="Expense" id="Expense"  class="form-control" placeholder="Enter Expense" required="" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="form_control_1">Date</label>
                                                        <input type="text" id="Date" name="Date" class="form-control date-picker" placeholder="Enter The Date"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="form_control_1">Amount</label>
                                                        <input name="Amount" id="Amount"  class="form-control" placeholder="Enter The Amount" required="" type="text">
                                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                <i class="icon-settings grey-gallery"></i>
                                                <span class="caption-subject bold uppercase">List of Expense</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                                ...
                                                <div class="col-md-12">
                                                    <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                        <div class="form-group col-md-offset-3 col-md-5">
                                                            <input type="text" value="" name="Search_Txt" class="form-control" id="Search_Txt" placeholder="Search Expense" required/>
                                                        </div>
        ...
        <script>
                                                            ...
                                                            function setEditdata(id)
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    type: 'POST',
                                                                    url: '<?php echo $web_url; ?>admin/querydata.php',
                                                                    data: {action: "GetAdminExpense", ID: id},
                                                                    success: function (response) {
                                                                        document.getElementById("editExpense").innerHTML = "EDIT Expense";
                                                                        $('#loading').css("display", "none");
                                                                        var json = JSON.parse(response);
                                                                        $('#Expense').val(json.expenseName);
                                                                        $('#Date').val(json.date);
                                                                        $('#Amount').val(json.amount);
                                                                        $('#action').val('EditExpense');
                                                                        $('<input>').attr('type', 'hidden').attr('name', 'expenseId').attr('value', json.expenseId).attr('id', 'expenseId').appendTo('#frmparameter');
                                                                    }
                                                                });
                                                            }
                                                            ...
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxExpense.php",
