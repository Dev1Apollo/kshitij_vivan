...
//                                                        });
                                                        ...
                                                        function checkclose() {
                                                            window.location.href = '<?php echo $web_url; ?>admin/Target.php';
                                                        }
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function (response) {
                                                                    if (response != 0)
                                                                    {
                                                                        ...
                                                                        window.location.href = '<?php echo $web_url; ?>admin/AddTarget.php';
                                                                    }
                                                                }
                                                            });
                                                        });
