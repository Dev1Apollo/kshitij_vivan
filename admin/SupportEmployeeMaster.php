...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Support Employee Master </title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Support Employee Master</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editExpense">Add Support Employee Master</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddSupportEmployeeMaster" name="action" id="action">
                                                <div class="form-body">
                                                    <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="support_emp_name" id="support_emp_name"  class="form-control" placeholder="Enter Name" required="" type="text">
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                <i class="icon-settings grey-gallery"></i>
                                                <span class="caption-subject bold uppercase">List of Support Employee Master</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
        ...
        <script>
                                                            ...
                                                            function setEditdata(id)
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    type: 'POST',
                                                                    url: '<?php echo $web_url; ?>admin/querydata.php',
                                                                    data: {action: "GetSupportEmployeeMaster", ID: id},
                                                                    success: function (response) {
                                                                        document.getElementById("editExpense").innerHTML = "EDIT Support Employee Master";
                                                                        $('#loading').css("display", "none");
                                                                        var json = JSON.parse(response);
                                                                        $('#support_emp_name').val(json.support_emp_name);
                                                                        
                                                                        $('#action').val('EditSupportEmployeeMaster');
                                                                        $('<input>').attr('type', 'hidden').attr('name', 'id').attr('value', json.id).attr('id', 'id').appendTo('#frmparameter');
                                                                    }
                                                                });
                                                            }
                                                            ...
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/AjaxSupportEmployeeMaster.php",
