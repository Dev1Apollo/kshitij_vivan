                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row" style="margin-bottom: 20px">
                                            ...
                                            $filterCourse = mysqli_fetch_array(mysqli_query($dbconn, "SELECT studentcourseId FROM studentcourse where stud_id='" . $stud_id . "' and studentcourse.istatus=1"));
                                            ?>
                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="portlet light ">
                                                                    <div class="portlet-title">
                                                                        <div class="caption grey-gallery">
                                                                            <i class="icon-settings grey-gallery"></i>
                                                                            <span class="caption-subject bold uppercase" id="listdetail">Edit Student Enrollment Detail</span>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="form-body">
                                                                                <div id="StudentCourse">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <hr />
                                                                                        <div class="col-md-12">
                                                                                            <h4 class="bold text-center">Student Enrollment Details</h4>
                                                                                        </div>
                                                                                        <!--                                                                                        <div class="form-group col-md-4">
                                                                                        <?php //$courseId  = explode(',',$stundentData['courseId']);
                                                                                        ?>
                                                                                                                                                                                    <label for="form_control_1">Course Name</label>
...
//                                                                                                while ($resultdata = mysqli_fetch_array($rowdata)) {
//                                                                                                    if ($stundentData['courseId'] == $resultdata['courseId']) {
                                                                                        ?>
                                                                                        ...
                                                                                        ?>
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="form-group col-md-4">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <div class="txt_field" id="FeeDiv" >
                                                                                                                                                                                        <input name="fee" id="fee" value="<?php // echo $stundentData['fee'];     ?>" class="form-control" placeholder="Enter The fee" disabled="" type="text" required="" readonly="readonly">
                                                                                                                                                                                    </div>
                                                                                                                                                                                </div>
                                                                                        
                                                                                                                                                                                <div class="form-group col-md-4">
                                                                                                                                                                                    <label for="form_control_1">Offered Fee*</label>
                                                                                                                                                                                    <input name="offeredfee" id="offeredfee" value="<?php // echo $stundentData['offeredfee'];     ?>" class="form-control" required="" placeholder="Enter The Offered Fee"  type="text" onchange="checkAmount();">
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="form-group col-md-4">
                                                                                                                                                                                    <label for="form_control_1">Registered Fees</label>
                                                                                                                                                                                    <input name="registeredAmount" id="registeredAmount" readonly="readonly" class="form-control date-picker" value="<?php echo $stundentData['booking_amount']; ?>"  type="text">
                                                                                                                                                                                </div>-->
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="form_control_1">Registration Date*</label>
                                                                                            <input name="dateOfRegistration" id="dateOfRegistration" value="<?php echo $query['strEntryDate']; ?>" class="form-control" placeholder="Enter The Date Of Registration" required="" type="text">
                                                                                        </div>
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="form_control_1">Enrollment Date*</label>
                                                                                            <input name="dateOfEnrollment" id="dateOfEnrollment" value="<?php echo $stundentData['EnrollmentDate']; ?>" required="" class="form-control date-picker" placeholder="Enter The Date Of Enrollment"  type="text">
                                                                                        </div>
                                                                                        <div class="form-group col-md-4">
        ...
        <script type="text/javascript">
                                                                                            ...
                                                                                            function checkAmount() {
                                                                                                ...
                                                                                                if (emiId == 1) {
                                                                                                    ...
                                                                                                    var noOfEmi = 1;
                                                                                                    var EmaiAmount = offeredAmount - booking_amount;
                                                                                                    EmaiAmount = Math.round(EmaiAmount / noOfEmi);
                                                                                                    $('#joinAmount').val(EmaiAmount);
                                                                                                } else {
                                                                                                    var offeredAmount = $('#offeredfee').val();
                                                                                                    noOfEmi = $('#noOfEmi').val();
                                                                                                    var EmaiAmount = offeredAmount - booking_amount - joinAmount;
                                                                                                    EmaiAmount = Math.round(EmaiAmount / noOfEmi);
