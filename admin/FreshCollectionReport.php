...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Fresh Collection Report</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Fresh Collection Report</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" >Fresh Collection Report</span>
                                        </div>
                                    </div>
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "AjaxFreshCollectionReport.php",
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    window.location.href = 'export-Fresh-Collection-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + "&branch=" + branch;
                                                                }
