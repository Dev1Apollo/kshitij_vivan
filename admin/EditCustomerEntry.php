                                           ...
                                           <div class="form-body">
                                               <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input value="<?php echo $row['mobileNo'];?>"  name="Mobile" id="Mobile"  class="form-control" placeholder="Enter The Mobile No." pattern="[0-9]{10}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-3">
...
function chkMobileno(ID)
            {
                ...
                var urlp = '<?php echo $web_url; ?>admin/findAdminCEMobileEdit.php?ID=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
