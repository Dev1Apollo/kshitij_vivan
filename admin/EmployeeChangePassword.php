...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Employee Change Password </title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span> Employee Change Password</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase">Employee Change Password</span>
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="fromchangepassword"  id="fromchangepassword" enctype="multipart/form-data" class="margin-bottom-40">
                                                <input type="hidden" value="EmployeeChangePassword" name="action">
                                                <input type="hidden" name="employeeMasterId" id="employeeMasterId" value="<?php echo $row['employeeMasterId'];?>">
                                                <div class="form-body">
