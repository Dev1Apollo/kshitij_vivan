...
$result = mysqli_query($dbconn,"SELECT * FROM `employeemaster` WHERE `employeeMasterId`='" . $_REQUEST['token'] . "'");
...
<html lang="en">
                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="EditAdminEmployee" name="action" id="action">
                                            <input type="hidden" value="<?php echo $row['employeeMasterId'] ?>" name="employeeMasterId" id="employeeMasterId">
                                            <div class="form-body">
                                                <div class="row">
                                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input value="<?php echo $row['mobileNo']; ?>" name="Mobile" id="Mobile"  class="form-control" placeholder="Enter Your Mobile No." pattern="[0-9]{10}" type="text">
                                                </div>
                                                 <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select name="iEmployeeType" id="iEmployeeType"  class="form-control" required="">
                                                            ...
                                                            <option value="1" <?php if($row['iEmployeeType'] == 1){echo 'selected';}?>>Employee</option>
                                                            <option value="2" <?php if($row['iEmployeeType'] == 2){echo 'selected';}?>>Supervisor</option>
                                                        </select>
                                                    </div> 
                                                </div>
                                                ...
                                                <hr>
                                                 ...
                                                 <div class="form-group col-md-3">
                                                    ...
                                                    <?php
                                                    $queryEmp = "SELECT * FROM `employeemaster`  where isDelete='0'  and  istatus='1' and employeeMasterId!='".$row['employeeMasterId']."' order by  employeeName asc";
                                                    ...
                                                    <option value=<?php echo $rowsEmp['employeeMasterId'] ?> ><?php echo $rowsEmp['employeeName'] ?> </option>
                                                    ...
                                                    ?>
                                                       ...
                                                       <div class="form-group col-md-3">
                                                            ...
                                                            while ($rowsbranch = mysqli_fetch_array($resultbranch)) { ?>
                                                                <option value=<?php echo $rowsbranch['branchid'] ?> <?php if($rowsbranch['branchid'] == $row['branchid']) { echo 'selected';} ?> ><?php echo $rowsbranch['branchname'] ?> </option>
                                                          <?php  }
                                                            echo "</select>";
                                                            ?>
                                                        </div> 
    ...
    <script type="text/javascript">
        ...
        function employeeTypeChange(){
            var iEmployeeType = $("#iEmployeeType").val(); 
            if(iEmployeeType == 2){
