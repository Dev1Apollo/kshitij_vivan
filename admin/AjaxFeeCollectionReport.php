...
if ($_POST['action'] == 'ListUser') {
   $where = "";
    ...
    $filterstr = "SELECT studentfee.*,studentadmission.* FROM `studentfee`,studentadmission WHERE studentadmission.stud_id=studentfee.stud_id and studentfee.amount!=0 and studentfee.feetype not in (5) and studentfee.isCancel=0  " . $where . " ORDER BY STR_TO_DATE(studentfee.payDate,'%d-%m-%Y') ASC";
    
    $countstr = "select count(*) as TotalRow, studentfee.*,studentadmission.* FROM `studentfee`,studentadmission WHERE studentadmission.stud_id=studentfee.stud_id and studentfee.amount!=0 and studentfee.feetype not in (5) and studentfee.isCancel=0 " . $where . "";
