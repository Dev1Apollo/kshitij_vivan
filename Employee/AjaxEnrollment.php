    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <!--                <th class="desktop">Action</th>-->
            ...
            <!--                <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><a href="CoursefeeDetails.php?token=<?php echo $rowfilter['stud_id']; ?>"><?php echo $rowfilter['title'] . ' ' . $rowfilter['firstName'] . ' ' . $rowfilter['middleName'] . ' ' . $rowfilter['surName']; ?> </a>
                            </div>
                        </td>   
                        <td>
                            <div class="form-group form-md-line-input "><?php
...
//                        }
            ...
            <!--                <td>
                            <div class="form-group form-md-line-input">
                                <a  class="btn blue" href="<?php // echo $web_url;  ?>Employee/CoursefeeDetails.php?token=<?php //  echo $rowfilter['stud_id'];  ?>" title="STUDENT ENROLLMENT FEES"><i class="fa fa-bars"></i></a>
                            </div>
                        </td>-->
                    </tr>
                <?php } ?>
