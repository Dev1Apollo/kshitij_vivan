    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <table class="table table-bordered table-hover center table-responsive dt-responsive" width="100%" id="tableC">
            ...
            <!--                                <a  class="btn blue" href="<?php echo $web_url; ?>Employee/EditCustomerEntry.php?token=<?php echo $rowfilter['customerEntryId']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                ...
                                <input type="button" class="btn blue" value="="  title="CREATE INQUIRY" onclick="window.open('<?php echo $web_url; ?>Employee/AddLead.php?token=<?php echo $rowfilter['customerEntryId']; ?>' , 'popUpWindow', 'height=500,width=1250,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes');">
<!--                                <a class="btn blue" href="<?php echo $web_url; ?>Employee/AddLead.php?token=<?php echo $rowfilter['customerEntryId']; ?>" onclick="return popitup('Employee/AddLead.php')" title="CREATE INQUIRY"><i class="fa fa-bars"></i></a>-->
                            </div>
                        </td>
