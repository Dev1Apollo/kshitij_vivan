...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> |  Registration</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" id="listdetail">List of Registered Student</span>
                                        </div>
...
//                                                                    $.ajax({
//                                                                        type: "POST",
//                                                                        url: "<?php // echo $web_url; ?>Employee/AddNewAdmission.php",
...
//                                                                }
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo $web_url; ?>Employee/AjaxRegistration.php",
                                                                    data: {action: 'ListUser', Page: Page, firstName: firstName, surName: surName, leaduniqueid: leaduniqueid},
                                                                    success: function (msg) {
