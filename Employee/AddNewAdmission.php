                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption grey-gallery">
                                                ...
                                                <span class="caption-subject bold uppercase" id="AddNewStudent"> Add New Student</span>
                                            </div>
                                            <form  role="form"  method="POST" class="pull-right" action="" name="frmsearch"  id="frmsearch" enctype="multipart/form-data">
                                                <div class="form-group col-md-9">
                                                    <input type="text" id="leaduniqueid" name="leaduniqueid"  class="form-control" placeholder="Enter The Lead Unique No.">
                                                </div>
                                                <input type="submit"  name="Serach" id="Serach" class="btn btn-sm blue pull-right" onclick="searchData();" value="Submit">
                                            </form>
                                            <?php
                                            $lid=0;
                                            if (isset($_REQUEST['leaduniqueid'])) {
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddStudentEntry" name="action" id="action">
                                                <input type="hidden" value="<?php if(isset($_REQUEST['leaduniqueid'])){ echo $row['leadId']; } else {echo "";} ?>" name="leadId" id="leadId">
                                                <input type="hidden" value="<?php if(isset($_REQUEST['leaduniqueid'])){ echo $row['customerEntryId']; } else {echo "";} ?>" name="customerEntryId" id="customerEntryId">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <?php
                                                            if (isset($_REQUEST['leaduniqueid'])) {
                                                                $query1 = mysqli_query($dbconn,"SELECT * FROM `lead` inner join customerentry on lead.customerEntryId=customerentry.customerEntryId where `leaduniqueid` = '" . $_REQUEST['leaduniqueid'] . "'");
                                                            ...
                                                            ?>" class="form-control" placeholder="Enter The City" required="" type="text">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for="form_control_1">Pin Code*</label><div id="errordiv"></div>
                                                            <input name="pincode" id="pincode"  class="form-control" placeholder="Enter The Pin Code" required="" type="text">
                                                        </div>
