...
if ($_POST['action'] == 'ListUser') {
	...
	$countstr = "SELECT count(*) as TotalRow FROM jobcategory inner JOIN jobmaster on jobcategory.iJobCategoryId=jobmaster.iJobCategoryId where jobmaster.isDelete=0 and jobmaster.iStatus=1";
			...
			<table class="table table-bordered table-hover center  dt-responsive" width="100%" id="tableC">
					<thead class="tbg">
						<tr>
    						...
    						<th class="desktop">Interview</th>
    						<th class="desktop">Selected</th>
    						<th class="desktop">Fail</th>
    						<th class="desktop">Joined</th>
    						<th class="desktop">Avg Salary</th>
						</tr>
					</thead>
					<tbody>
						<?php
						...
						?>
							<tr>
    							...
    							<td>
    								<div class="form-group form-md-line-input "><?php echo $rowfilter['Interview']; ?>
    								</div>
    							</td>
    							<td>
    								<div class="form-group form-md-line-input "><?php echo $rowfilter['Pass']; ?>
    								</div>
    							</td>
    							
    							<td>
    								<div class="form-group form-md-line-input "><?php echo $rowfilter['Fail']; ?>
    								</div>
    							</td>
    							<td>
    								<div class="form-group form-md-line-input "><?php echo $rowfilter['Join']; ?>
    								</div>
    							</td>
    							<td>
    								<div class="form-group form-md-line-input"><?php echo round($rowfilter['Avg_Salary'],2); ?>
    								</div>
    							</td>
							</tr>
						<?php } ?>
