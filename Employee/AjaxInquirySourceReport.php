...
//GROUP by customerentry.inquirySourceId
    ...
    $filterstr = "select sum((select count(*) from lead l1 where l1.leadId = lead.leadId ".$where." )) as Inqcount,customerentry.inquirySourceId ,sum((select count(*) from lead l1 where l1.leadId = lead.leadId and l1.statusId=3 ".$whereB." )) as bookedInq ,"
            ...
            . "customerentry where customerentry.customerEntryId = lead.customerEntryId and lead.employeeMasterId = '".$_SESSION['EmployeeId']."' " . $whereA. "  GROUP by customerentry.inquirySourceId";
    ...
    $countstr = "select count(*) as TotalRow,customerentry.inquirySourceId ,sum((select count(*) from lead l1 where l1.leadId = lead.leadId and l1.statusId=3 ".$where." )) as BookingCount ,"
            ...
            . "customerentry where customerentry.customerEntryId = lead.customerEntryId and lead.employeeMasterId = '".$_SESSION['EmployeeId']."' ". $where .$whereA."  GROUP by customerentry.inquirySourceId";
 // echo $filterstr;exit;
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php    
                                /*$perntage = $rowfilter['walkingcount'] / $rowfilter['Inqcount'];
                        ...
                        <td>
                         ...
                         <td>
                            <div class="form-group form-md-line-input "><?php if($rowfilter['bookingamount'] != '') {echo $rowfilter['bookingamount']; }  else { echo '0';} ?> 
                            </div>
                        </td>
                        <?php
                    }
