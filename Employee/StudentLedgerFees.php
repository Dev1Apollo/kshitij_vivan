...
//                                                                            
?>
                                                                            <input type="hidden" value="<?php // echo $rowdata['stud_id'];  ?>" name="stud_id" id="stud_id">
                                                                            <input type="hidden" value="<?php // echo $rowdata['courseId'];  ?>" name="courseName" id="courseName">
...
<?php // }   ?>
    ...
    <script>
        ...
        function getcourse()
        {
            ...
            var urlp = '<?php echo $web_url; ?>Employee/findCourse.php?cid=' + q + "&stud_id=" + stud_id;
            $.ajax({
                type: 'POST',
                url: urlp,
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != 0)
                    {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Employee/StudentEnrollmentFees.php?token=' + response;
                    }
                }
            });
        });
        ...
        function deletedata(task, id)
        {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Employee/AjaxStudentFee.php",
