...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-md-2 col-md-offset-1 col-form-label">Enrollment *</label><div id="errordiv"></div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="staticEmail" class="col-md-2 col-md-offset-1 col-form-label">FPS *</label><div id="errordiv"></div>
                                                            <div class="col-md-4">
        ...
        <script type="text/javascript">
                                                        ...
                                                        function checkclose() {
                                                            window.location.href = '<?php echo $web_url; ?>Employee/AddTarget.php';
                                                        }
