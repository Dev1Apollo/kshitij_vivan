...
<head>
    ...
    <link
        href="<?php echo $web_url; ?>admin/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css"
...
<body class="page-container-bg-solid page-boxed">
    ...
    <script
        src="<?php echo $web_url; ?>admin/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"
    ...
    function deletedata(task, id) {
        ...
        if (confirm(errMsg)) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/AjaxJobMaster.php",
                data: {
                    action: task,
                    ID: id
                },
