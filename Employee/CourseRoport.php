        ...
        <script>
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    ...
                    data: {action: 'ListUser', Page: Page, studentStatus: studentStatus, FormDate: FormDate, ToDate: ToDate, studentcourseId: studentcourseId},
            ...
            function exportexceldata()
            {
                ...
                alert('export-Course-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate);
                window.location.href = 'export-Course-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate;
            }
