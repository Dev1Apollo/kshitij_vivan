...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM studentadmission  " . $where . " and isRegister = '1' and isAdmission = '0' and branchId=" . $_SESSION['branchid'] . "  ORDER BY `studentadmission`.`stud_id` deSC";
//    $filterstr = "SELECT * FROM `studentadmission`  " . $where . " and isDelete='0'  and  istatus='1' order by  stud_id desc";
    $countstr = "SELECT count(*) as TotalRow FROM studentadmission  " . $where . " and isRegister = '1' and isAdmission = '0' and branchId=" . $_SESSION['branchid'] . "";
        ...
        <!--                        <th class="desktop">Action</th>-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-md-line-input ">
                                    <a href="<?php echo $web_url; ?>Employee/AddRegisterFee.php?token=<?php echo $rowfilter['stud_id']; ?>">
            ...
            <!--                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <a href="<?php // echo $web_url;  ?>Employee/AddRegisterFee.php?token=<?php // echo $rowfilter['stud_id'];  ?>" title="REGISTRATION FEES"><i class="fa fa-bars"></i></a>
                                </div>
                            </td>-->
                        </tr>
                    <?php } ?>
