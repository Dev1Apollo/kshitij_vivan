...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Fees Collection Report</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" >Fees Collection Report</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <input type="text" id="StudentName" name="StudentName" class="form-control" placeholder="Search Student" />
                                                        </div>
                                                        <div class="form-group col-md-2">
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        data: {action: 'ListUser', Page: Page, StudentName: StudentName, studentPortal_Id: studentPortal_Id, FormDate: FormDate, ToDate: ToDate},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    var studentPortal_Id = $('#studentPortal_Id').val();
                                                                    var StudentName = $('#StudentName').val();
                                                                    window.location.href = 'export-Fee-Collection-Report.php?FormDate=' + FormDate + "&ToDate=" + ToDate + '&studentPortal_Id=' + studentPortal_Id + '&StudentName=' + StudentName;
                                                                }
