...
<html lang="en">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="form_control_1">Comment</label><div id="errordiv"></div>
    ...
    <script type="text/javascript">
                                                    ...
                                                    function checkclose() {
                                                        history.go(-1);
                                                        return false;
//            window.location.href = '<?php echo $web_url; ?>Employee/student-emi.php';
                                                    }
...
//                        alert(data);
                                                    ...
                                                    function getAmount() {
                                                        ...
                                                        var urlp = '<?php echo $web_url; ?>Employee/findEmiAmount.php?offeredfee=' + offeredAmount + "&noOfEmi=" + noOfEmi + "&stud_id=" + stud_id + "&joinAmount=" + joinAmount;
                                                        $.ajax({
                                                            type: 'POST',
                                                            url: urlp,
                                                            success: function (data) {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (response) {
                                                                ...
                                                                if (response != 0)
                                                                {
                                                                    ...
                                                                    window.location.href = '<?php echo $web_url; ?>Employee/student-emi.php?token=' + response;
                                                                }
                                                            }
