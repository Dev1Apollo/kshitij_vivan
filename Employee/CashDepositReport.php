...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Cash Deposit Report </title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" >List of Cash Deposit Report</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <select name="bankDeposit[]" id="bankDeposit" multiple="multiple" class="form-control" required="">
        ...
        <script>
                                                                ...
                                                                function PageLoadData(Page) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        data: {action: 'ListUser', Page: Page, FromDate: FromDate, ToDate: ToDate, bankDeposit: bankDeposit, studentPortal_Id: studentPortal_Id},
                                                                ...
                                                                function exportexceldata()
                                                                {
                                                                    ...
                                                                    window.location.href = 'export-cash-deposit-report.php?FromDate=' + FromDate + "&ToDate=" + ToDate + "&studentPortal_Id=" + studentPortal_Id + "&bankDeposit=" + bankDeposit;
                                                                }
