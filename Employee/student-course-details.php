...
<!--                                                                        <input type="button" value="Next Page" class="btn blue" id="nextPage" onclick='window.location.href = "<?php echo $web_url; ?>Employee/student-fees.php?token=<?php echo $query['stud_id']; ?>"' />-->
                                                                    </div>
                                                                </div>
...
//                                                                                var q = $('#cid').val();
////                alert(q);
//                                                                                var urlp = '<?php echo $web_url; ?>Employee/findSoftwhere.php?cid=' + q;
//                                                                                $.ajax({
//                                                                                    type: 'POST',
//                                                                                    url: urlp,
...
//                                                                                            window.location.href = '<?php echo $web_url; ?>Employee/student-course-details.php?token=' + response;
//                                                                                        }
//                                                                                    }
//
//                                                                                });
//                                                                            });
                                                                            ...
                                                                            function PageLoadData(Page) {
                                                                                ...
                                                                                $.ajax({
                                                                                    type: "POST",
                                                                                    url: "<?php echo $web_url; ?>Employee/AjaxStudentSoftware.php",
                                                                                    data: {action: 'ListUser', Page: Page, courseName: courseName,softwareName: softwareName ,stud_id: stud_id},
