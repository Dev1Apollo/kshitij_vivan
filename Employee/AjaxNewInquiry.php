...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `lead`  where isNewInquiry='1' and employeeMasterId='" . $_SESSION['EmployeeId'] . "'  order by  leadId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `lead`  where isNewInquiry='1' and employeeMasterId='" . $_SESSION['EmployeeId'] . "' ";
                    ...
                    echo $rowfilter['nextFollowupDate'];
                        ...
                        <td >
                            <div class="form-group form-md-line-input">
                                ...
                                <?php } else { ?>
<!--                                <button onclick="window.open('<?php echo $web_url; ?>Employee/AddInquiryFollowup.php?token=<?php echo $rowfilter['leadId']; ?>&cid=<?php echo $rowfilter['customerEntryId']; ?>')" vlaue="INQUIRY FOLLOWUP">INQUIRY FOLLOWUP</button>-->
