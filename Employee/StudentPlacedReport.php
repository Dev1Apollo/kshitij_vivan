...
<body class="page-container-bg-solid page-boxed">
	...
	<script type="text/javascript">
		...
		function PageLoadData(Page) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $web_url; ?>Employee/AjaxStudentPlacedReport.php",
				data: {
					action: 'ListUser',
					Page: Page,
					FormDate: FormDate,
        ...
        {;
            ...
            var Url = '<?php echo $web_url; ?>Employee/exportStudentPlacedReport.php?FormDate=' + FormDate + '&ToDate=' + ToDate;
            window.open(
              Url,
