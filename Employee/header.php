            ...
            <div class="hor-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php if (isset($_SESSION['EmployeeId']) && isset($_SESSION['EmployeeName'])) { ?> 
                        ...
                        ?>">
                            <a href="<?php echo $web_url; ?>Employee/CustomerEntry.php">LMS</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown  <?php
                            ...
                            ?>">
                            <a href="<?php echo $web_url; ?>Employee/StudentRegistration.php">Student Admission</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown <?php if (in_array(parse_url(basename(($_SERVER['REQUEST_URI'])), PHP_URL_PATH), $JobSubEntry)){
							...
							<a href="<?php echo $web_url; ?>Employee/CompanyMaster.php">Placement</a>
						</li>
                        <?php
                    }
                    ?>
