...
//                                echo $query['courseName'];
                        ...
                        <td>
                            <div class="form-group form-md-line-input">
                                <a  class="btn blue"  href="<?php echo $web_url; ?>Employee/StudentEnrollmentFees.php?token=<?php echo $rowfilter['stud_id']; ?>&studentcourseId=<?php echo $rowfilter['studentcourseId']; ?>" title="STUDENT FEES"><i class="fa fa-rupee"></i><strong> Fees</strong></a>
<!--                                <a  class="btn blue" href="<?php // echo $web_url; ?>Employee/StudentFeesHistory.php?token=<?php // echo $rowfilter['stud_id']; ?>&studentcourseId=<?php // echo $rowfilter['studentcourseId']; ?>"   title="STUDENT HISTROY"><i class="fa fa-history iconshowFirst"></i></a>
