...
if ($_POST['action'] == 'ListUser') {
    ...
    $countstr = "SELECT count(*) as TotalRow,avg(DATEDIFF(STR_TO_DATE(walkin_datetime,'%d-%m-%Y'),STR_TO_DATE(inquiryEnterDate,'%d-%m-%Y'))) AS timediff FROM `lead`  " . $where . " and  isNewInquiry='0' and employeeMasterId='" . $_SESSION['EmployeeId'] . "' and   walkin_datetime != ''  ";
