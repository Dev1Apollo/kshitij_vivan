                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response != 0)
                        {
                            ...
                            window.open('<?php echo $web_url; ?>Employee/AddLead.php?token=' + response , 'popUpWindow', 'height=500,width=1250,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes');
                        }
                    }
