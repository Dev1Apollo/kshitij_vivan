...
if ($_POST['action'] == 'ListUser') {
    ...
    if ($_POST['surName'] != NULL && isset($_POST['surName'])) 
            $where.=" and  lastName like '%$_POST[surName]%'";
    if ($_POST['leaduniqueid'] != NULL && isset($_POST['leaduniqueid']))
            $where.=" and  leaduniqueid like '%$_POST[leaduniqueid]%'";
    
    $filterstr = "SELECT * FROM studentadmission  ".$where."  and branchId=".$_SESSION['branchid']."";
//    $filterstr = "SELECT * FROM `studentadmission`  " . $where . " and isDelete='0'  and  istatus='1' order by  stud_id desc";
    $countstr = "SELECT count(*) as TotalRow FROM studentadmission  ".$where."  and branchId=".$_SESSION['branchid']."";
...
<!--                <th class="desktop">Action</th>-->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group form-md-line-input "><?php 
                        $filterBookingId = mysqli_fetch_array(mysqli_query($dbconn,"select bookingId from studentcourse where stud_id=".$rowfilter['stud_id']." and studentcourse.istatus=1"));
                        echo  $filterBookingId['bookingId']; 
                    ?> 
                    </div>
                </td>
                <td>
                    <div class="form-group form-md-line-input ">
                        <a href="<?php echo $web_url; ?>Employee/AddOnAccountFee.php?token=<?php echo $rowfilter['stud_id']; ?>">
...
<!--                <td>
                    <div class="form-group form-md-line-input">
                        ...
                        <a  class="btn blue" href="<?php echo $web_url; ?>Employee/AddOnAccountFee.php?token=<?php echo $rowfilter['stud_id']; ?>" title="REGISTRATION FEES"><i class="fa fa-bars"></i></a>
