...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Enrollment Fees</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption grey-gallery">
                                            ...
                                            <span class="caption-subject bold uppercase" id="listdetail">List of Enrolled Student</span>
                                        </div>
        ...
        <script type="text/javascript">
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>Employee/AjaxEnrollment.php",
